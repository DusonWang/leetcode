...
public class SubArraySum2 {
    ...
    public static void main(String[] args) {
        SubArraySum2 subArraySum2 = new SubArraySum2();
        int[] nums = new int[]{1, 1, -1, 1, 2, 3, 4, 5};
        int target = 8;//{3,5}{1,4,3}{1,2,5}
        System.out.println(subArraySum2.findSumWays2(nums, target, 2));
        System.out.println(subArraySum2.findSumWays2(nums, target, 3));
        System.out.println(subArraySum2.findSumWays2(nums, target, 4));
